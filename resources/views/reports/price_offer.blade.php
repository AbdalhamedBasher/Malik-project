...
<body dir="rtl" lang="ar">
    ...
    <div>
        ...
        <div class="region_project_number">
            ...
            <h3 class="project_number">رقم المشروع :{{ $qoute->project_data->serial }}</h3>
...
<img src="data:image/png;base64,{{ $image }}" style="width:10%;height:10%;" class="first-img">            <div>
                <h3 >مؤسسة إدارة المساحات للمقاولات</h3>
                <h3>Spaces Management Est. For Contracting</h3>

            </div>
            <img src="data:image/png;base64,{{ $image }}" style="width:10%;height:10%;" class="first-img">
        </div>
        <div class="contents">
            <h3>المحتويات :</h3>
            <ol>
       ...
       <div>
        ...
        <p class="topic-main">
            إشارة إلى الموضوع أعلاه ، نشكركم لدعوتكم لنا ويسرنا ويشرفنا أن نتقدم لكم بعرض سعرنا الخاص بعملية <span
                ...
                المبلغ (5,113,381.24 ريال سعودي )، خمسة مليون وثلاثة عشرة ألف وثلاثمائة وواحد وثمانون ريال سعودي فقط
                وأربعة عشرون هللة لا غير ،</span> وذلل حسب وذلك حسب جداول الكميات والبنود والكميات والأسعار المرفقة مع
            هذا العرض .(، وذلك وفقاً للمواصفات والكميات والأسعار المرفقة مع هذا العرض.
        </p>
        ...
        <div>
            ...
            <div>
                ...
                <div class="page-footer">
                    ...
                    <div>
            <img src="data:image/png;base64,{{ $image }}">                    </div>
                    <div>
