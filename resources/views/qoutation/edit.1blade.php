                                ...
                                <div class="card-body border-2">
                                    ...
                                    <div class="table-responsive">
                                        <div class="">
                                            ...
                                            <label class="" for="">
                                                {{ $children->name }}  {{ $qoute_batch[$children->id]->line == $children->id ? 'checked' : '' }}
                                                        ...
                                                        <tr id="{{ $value->qoute_batch_items->lines->item_lines }}">
                                                                    ...
                                                                    <select class="form-control products w-full"
                                                                        ...
                                                                        @foreach ($items as $item)
                                                                            <option
                                                                                ...
                                                                                value="{{ $item->id }}"
                                                                                data-price="{{ $item->price }}"  {{$item->id==$value->item?'selected':'2'}}>
                                                                                {{ $item->name }} {{$item->id==$value->items->id?'selected':'2'}}
                                                                            </option>
                                                                        @endforeach
                                                                    </select>
                                                                @endif
                                                            ...
                                                            <td style="text-align: center">
                                                                ...
                                                                <input type="text"
                                                                    ...
                                                                    value="{{ $product_factor ?? 0 }}"
                                                                    class="border border-1 simetot"
                                                                    {{ $profit_summary[$children->id] += $product_factor }}>
                                                            </td>
                                                            <td style="text-align: center">
